...
// Версия для RP2040W (RP2040)PI PICO

/*  19.03.2024 - // Переведено на библиотеку AD9833
                 // https://github.com/UA6EM/AD9833/tree/mpgsp
                 // Переход на новый микроконтроллер RP2040W
                 // Переход на TFT IPS дисплей
...
enum { sbNONE = 0,
       sbClick,
       sbLong }; /*состояние не изменилось/клик/долгое нажатие*/
class Cl_Btn {
protected:
  const byte pin;
  byte state;
