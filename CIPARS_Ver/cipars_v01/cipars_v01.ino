...
// с антипаразитарной функцией по Хильде Кларк
// 03.03.2024 - проба режима цеппера, включается тройным коротким нажатием кнопки
// работает в цикле выдавая частоту от 30Кгц до 1Mhz (строки от 372)
