...
/*   07.04.2024 - исправлено поведение программы при длительном нажатии кнопки
     а именно вход в рабочий режим СТАТИКИ (катушка)
     добавлен зуммер окончания работы с очками в режиме ZEPPER
     

     Поведение программы можно посмотреть в симуляторе wokwi
     https://wokwi.com/projects/394401213274045441
    ...
    25.02.2024 - Версия CIPARS для потенциометра  X9C, управление AD9833 напрямую через SPI
...
bool SbLong = false;                  // флаг длительного нажатия кнопки
